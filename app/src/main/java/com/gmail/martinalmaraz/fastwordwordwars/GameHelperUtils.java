...
import com.gmail.martinalmaraz.fastwordwordwars.R;
...
class GameHelperUtils {
    ...
    static String getString(Context ctx, int whichString) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.w(com.google.example.games.basegameutils.GameHelper.TAG, "*** GameHelper could not found resource id #" + resId + ". " +
